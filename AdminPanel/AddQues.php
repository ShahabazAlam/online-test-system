...
<div class="jumbotron">
   <div class="container">    
     <div id="loginbox" style="margin-top:10px;" class="mainbox col-md-4 col-md-offset-4 col-xs-12 col-xs-offset-0">
      <form method="POST" action="SaveQues.php">                    
        <div class="panel panel-info" >
           <div class="panel-heading">
             <div class="panel-title"><strong>Add:Question</strong></div>
           </div>     
               <div style="padding-top:30px" class="panel-body" >
                 <div style="display:none" id="login-alert" class="alert alert-danger col-xs-12"></div>
                      <div style="margin-bottom: 25px" class="input-group">
          <center>  Question: <input type="text" name="question"><br><br>
          <hr>
             Option1: <input type="text" name="Option1"><br><br>
                Option2: <input type="text" name="Option2"><br><br>
                   Option3: <input type="text" name="Option3"><br><br>
                      ...
                      <hr>
                        ACode1: <input type="text" name="code1"><br><br>
                         ACode2: <input type="text" name="code2"><br><br>
                          ACode3: <input type="text" name="code3"><br><br>
                           ACode4: <input type="text" name="code4"><br><br>
                        <hr></center>
                                      <div style="margin-top:10px" class="form-group">
                                    <!-- Button -->

                                    <div class="col-sm-12 controls">
                                      <input type="submit" name="submit" value="Save Question" class="btn btn-success">
                                    </div>
                                </div>    
                            </div>                     
                       </div> 
