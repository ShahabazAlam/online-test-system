...
<head>
 ...
 <link rel="stylesheet" href="AllQues.css">
</head>
<body>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8"> 
    <div style="width:100%"><h2>All Questions</h2></div>
            <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                     ...
                     $qry2 = "select * from questions,answers where questions.q_id = answers.a_id AND answers.ans = 1";
         ...
         ?>            <tr>
              ...
              <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
               <a href="DelQues.php?uid=<?php echo $data['q_id']?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                         </tr>  
                 <?php
                      }
